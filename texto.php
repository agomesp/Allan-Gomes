<?php
    ...
    $postSelecionado = getPostSelecionado($conexao, $_GET['id']);
...
<html class="no-js" lang="">
    ...
    <body id="body">
        <section id='section-texto'>
            <h1><?= $postSelecionado['titulo']?></h1>
            <p>Escrito por Allan Gomes</p>
            <p><?= $postSelecionado['data']?></p>
            <img src="../<?= $postSelecionado['img']?>" style="width: 100%;">
            <p><?= $postSelecionado['texto']?></p>
        </section>
